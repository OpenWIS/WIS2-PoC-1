...
public class DatasetWS {
	...
	public Response userVerification(DatasetDTO dataset) {
		...
		System.out.println("I got At WS: \n "+dataset.toString());
		logger.log(Level.WARNING, "I got At WS: \n "+dataset.toString());
		//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    // edw prepei na kanei read..............................................................
		  return Response.ok((datasetService.saveDataset(new DatasetDTO())))
                  .header(CorsHeaderConstants.HEADER_AC_ALLOW_METHODS, "GET,HEAD,OPTIONS,POST,PUT")
                  .header(CorsHeaderConstants.HEADER_AC_ALLOW_CREDENTIALS, "true")
                  .header(CorsHeaderConstants.HEADER_AC_ALLOW_ORIGIN, "*")
                  .header(CorsHeaderConstants.HEADER_AC_ALLOW_HEADERS, "Access-Control-Allow-Headers, origin, content-type, accept, authorization, Origin, Content-type, Accept, Authorization")
                  .build();
}
